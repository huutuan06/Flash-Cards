...
import com.flashcards.flashcards.databinding.ItemProgresstBinding
...
class ProgressAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(ItemProgresstBinding.inflate(inflater, parent, false))
    }
    ...
    class ViewHolder(val binding: ItemProgresstBinding) : RecyclerView.ViewHolder(binding.root)
}
